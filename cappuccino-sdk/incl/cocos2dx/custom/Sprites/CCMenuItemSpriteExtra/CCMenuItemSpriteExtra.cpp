...
void CCMenuItemSpriteExtra::selected(){
	...
	auto resize = cocos2d::CCScaleTo::create(0.2, m_sizeMult * m_origScale);
	//auto bounce = cocos2d::CCEaseBounceOut::create(resize);
	auto bounce = cocos2d::CCEaseExponentialOut::create(resize);
...
void CCMenuItemSpriteExtra::unselected(){
	...
	auto resize = cocos2d::CCScaleTo::create(0.2, m_origScale);
	//auto bounce = cocos2d::CCEaseBounceOut::create(resize);
	auto bounce = cocos2d::CCEaseExponentialOut::create(resize);
	this->runAction(bounce);
}
